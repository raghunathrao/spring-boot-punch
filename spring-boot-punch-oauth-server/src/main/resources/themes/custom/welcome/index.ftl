  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      ...
      <div class="row">
          ...
          <div class="card-pf h-l">
            ...
            <div class="welcome-primary-link">
              ...
              <div class="description">
                Centrally manage all aspects of the ${properties.documentationUrl} server
              </div>
            </div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-l">
            <h3><a href="${properties.productNameFull}"><img class="doc-img" src="welcome-content/admin-console.png">Documentation <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
            <div class="description">
